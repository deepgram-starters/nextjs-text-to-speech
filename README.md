...
Go to GitHub and [clone the repository](https://github.com/deepgram-starters/nextjs-text-to-speech).
...
- [Open an issue in this repository](https://github.com/deepgram-starters/nextjs-text-to-speech/issues)
